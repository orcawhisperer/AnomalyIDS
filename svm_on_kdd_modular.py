...
class MySVM(object):
    ...
    def train_cross_validationset(self,features_train,labels_train):
            ...
            scores = model_selection.cross_val_score(clf,features_train,labels_train,cv=5)
            print('Scores : \t',scores)
            train_t1 = time1.time()
            print("End Training the System",time1.ctime())
            print("Trainig Phase: {} records are trained in {} ".format(len(features_train),train_t1-train_t0))
    ...
    def main(self):
            filename="./KDDTrain.csv"#"kddcup.data_10_percent_corrected"#"20000_records_file.data"
            split=0.4
